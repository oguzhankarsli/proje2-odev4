...
public:
        ...
        screen_height(screen_height)
    {
		...
		ColorCorrMap = glGetUniformLocation(programID, "ColorCorrMap");
        if (ColorCorrMap == -1)
		{
	...
	void drawImage(){
		...
		loadTexture("_ColorCorrMap.jpg", 800, 1);
    ...
    void resize(){
		...
		glRenderbufferStorageEXT(GL_RENDERBUFFER, GL_DEPTH_COMPONENT32, *screen_width, *screen_height);
